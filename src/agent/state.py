...
@dataclass
class Task:
    """Одна просьба клиента со своими полями и счётчиками уточнений."""
...
@dataclass
class PendingAction:
    """Операция с согласованными параметрами, ожидающая подтверждения клиента."""
...
@dataclass
class DialogState:
    """Контекст сеанса: язык, задачи, история и ожидаемый следующий шаг."""
...
@dataclass
class TurnResult:
    """Готовый ответ клиенту и трассировка для проверки работы движка."""
