...
|---|---|---|---|
| Русский, казахский, смешанная речь | 40 бизнес-сценариев + 3 системных | Голос и текст в Telegram | 75 локальных тестов |
...
Откройте своего бота в Telegram, нажмите **Start** и отправьте «Здравствуйте»
...
75 тестов проверяют загрузку данных, ответы маршрутизатора, переходы диалога,
подтверждения, разбор номеров и Telegram-обработчики. Внешние API в них подменены.
